                ...
                for datasource in dict_cell_lines_info[cell_name][assay_type]:
                    if "metadataENCODE" in datasource:
                        if assay_type=="TF_ChIP-seq":
                            ...
                            ENCODE_accession_codes_dict = generate_list_of_accession_info(datasource, cell_name,  assembly, 'candidate Cis-Regulatory Elements', accepted_file_formats=['bed bed3+'], default_target_name='candidate Cis-Regulatory Elements',index_assay_type=5,index_assembly=22)
