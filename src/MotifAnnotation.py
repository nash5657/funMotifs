                        ...
                        while line:
                            ...
                            if(sline[7]!='.'):
                                ...
                                for cell in cell_assay_values_dict_ChromHMM:
                                    ...
                                    elem_list_EpiMap.append(cell+"#ChromHMM#"+Counter(cell_assay_values_dict_ChromHMM[cell]).most_common(1)[0][0])
                                for cell in cell_assay_values_dict_cCRE.keys():
                                    ...
                                    eelem_list_EpiMap.append(cell+"#cCRE#"+Counter(cell_assay_values_dict_cCRE[cell]).most_common(1)[0][0])

                                for cell in cell_assay_values_dict_IndexDHS.keys():
                                        #print(cell_assay_values_dict_IndexDHS[cell])
                                    elem_list_EpiMap.append(cell+"#IndexDHS#"+Counter(cell_assay_values_dict_IndexDHS[cell]).most_common(1)[0][0])
                                for cell in cell_assay_values_dict_RegElem.keys():
                                        #print(cell_assay_values_dict_IndexDHS[cell])
                                    elem_list_EpiMap.append(cell+"#RegElem#"+Counter(cell_assay_values_dict_RegElem[cell]).most_common(1)[0][0])
                
                                outfile.write('\t'.join(sline[0:7])+','.join(elem_list_EpiMap)+','.join(elem_list))
